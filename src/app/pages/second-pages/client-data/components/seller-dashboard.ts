    ...
    <div class="py-16 lg:py-24">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div class="p-6 rounded-2xl bg-surface-0 dark:bg-surface-900 shadow-card">
          <h3 class="text-xl font-semibold mb-4 text-surface-950 dark:text-surface-0">Property Listings</h3>
          <p class="text-surface-600 dark:text-surface-400">Your active listings will appear here.</p>
        </div>
        <div class="p-6 rounded-2xl bg-surface-0 dark:bg-surface-900 shadow-card">
          <h3 class="text-xl font-semibold mb-4 text-surface-950 dark:text-surface-0">Market Analysis</h3>
          <p class="text-surface-600 dark:text-surface-400">Your property valuation data will appear here.</p>
        </div>
        <div class="p-6 rounded-2xl bg-surface-0 dark:bg-surface-900 shadow-card">
          <h3 class="text-xl font-semibold mb-4 text-surface-950 dark:text-surface-0">Showing Requests</h3>
          <p class="text-surface-600 dark:text-surface-400">Buyer showing requests will appear here.</p>
        </div>
        <div class="p-6 rounded-2xl bg-surface-0 dark:bg-surface-900 shadow-card">
          <h3 class="text-xl font-semibold mb-4 text-surface-950 dark:text-surface-0">Offers Received</h3>
          <p class="text-surface-600 dark:text-surface-400">Active offers on your property will appear here.</p>
        </div>
      </div>
    </div>
  `,
