      ...
      <div class="container">
        ...
        >
          <div class="absolute inset-0 overflow-y-clip">
            ...
            >
              <div
                class="title text-3xl lg:text-5xl bg-[linear-gradient(180deg,rgba(255,255,255,0.80)_4.92%,rgba(255,255,255,0.40)_89.39%)] leading-none"
              >
                Wanderlust Awaits
              </div>
              <div
                class="title bg-[linear-gradient(180deg,#FFF_-16.99%,rgba(255,255,255,0.00)_100%)] text-8xl lg:text-[17rem] leading-none lg:-mt-14 text-center"
              >
                Augie Lopez REA
              </div>
            </div>
