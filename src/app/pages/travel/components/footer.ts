  ...
  template: `
    <animated-container className="max-w-[82rem] px-4 mx-auto mt-24 lg:mt-64 ">
      ...
      >
        ...
        <div
          class="lg:block hidden absolute left-1/2 -translate-x-1/2 z-2 text-[6rem] lg:text-[18rem] top-60 lg:top-0 font-semibold title [background-image:radial-gradient(235.17%_97.94%_at_53.25%_-29.68%,#FFF_0%,rgba(255,255,255,0.00)_97%)] text-center"
        >
          Augie Lopez REA
        </div>
